...
static const char dmenufont[]       = "monospace-8";
...
static const char col_blue[]         = "#008080";
static const char *colors[][3]      = {
	/*               fg          bg         border   */
	[SchemeNorm]  = { col_gray4, col_black, col_gray2 },
	[SchemeSel]   = { col_red,   col_black, col_gray4 },
	[SchemeTitle] = { col_gray3, col_black, col_black },
};
